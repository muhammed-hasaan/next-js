...
import CurentlyDeployedResourcesDetail from "../../../../../Components/DashboardComponents/ResourceManagement/CurrentlyDeployedResources/CurrentlyDeployedResourcesDetail/CurrentlyDeployedResourcesDetail";
import DashboardLayout from "../../../../../Sections/DashboardSections/dashboard";

const CurrentlyDeployedResourcesDetail = () => {
  return (
    <DashboardLayout>
      ...
      <div className="flex justify-end items-end w-[100%]">
        <div className="p-6 bg-gray-50 min-h-screen w-[80%] responsiveFullWidth  ">
          ...
          <div className="flex justify-center items-center flex-col">
            <div className="mt-6">
              <CurentlyDeployedResourcesDetail />
            </div>
          </div>
        </div>
      </div>
...
export default CurrentlyDeployedResourcesDetail;
